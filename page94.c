...
/*This program asks the user for their birth year and calculates how old
they will be in the current year. It will check to make sure a future year has not been
entered. It will tell the user if they were born in a leap year.*/
...
//The statements will only execute if the year is after
//the earlier defined current year
