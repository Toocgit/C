...
/*This program defines a series of variables and expressions and then uses both relational
and logical operators to test them against each other*/
...
//whether the cast of friends and the Beatles would have enough
//people to make a baseball team AND whether the cast of Friends
//and the Avengers would have enough people to field a football team
